...
module.exports = {
  ...
  async up (queryInterface, Sequelize) {
    ...
    return await queryInterface.bulkInsert('Expense', [
      ...
      {user_id: 2,  date: '2025-01-20', amount: 80.00, description: 'Alquiler', recurring: true, category_id: 2 },
      {user_id: 2,  date: '2025-01-25', amount: 90.00, description: 'Compra en supermercado', recurring: false, category_id: 1 },
      ...
      {user_id: 2,  date: '2025-02-20', amount: 85.00, description: 'Alquiler', recurring: true, category_id: 2 },
      {user_id: 2,  date: '2025-02-25', amount: 95.00, description: 'Compra en supermercado', recurring: false, category_id: 1 },
      ...
      { user_id: 3,  date: '2025-01-18', amount: 82.00, description: 'Alquiler', recurring: true, category_id: 2 },
      { user_id: 3,  date: '2025-01-23', amount: 92.00, description: 'Compra en supermercado', recurring: false, category_id: 1 },
      ...
      { user_id: 3,  date: '2025-02-18', amount: 87.00, description: 'Alquiler', recurring: true, category_id: 2 },
      { user_id: 3,  date: '2025-02-23', amount: 97.00, description: 'Compra en supermercado', recurring: false, category_id: 1 },
      ...
      { user_id: 4,  date: '2025-01-17', amount: 84.00, description: 'Alquiler', recurring: true, category_id: 2 },
      { user_id: 4,  date: '2025-01-22', amount: 94.00, description: 'Compra en supermercado', recurring: false, category_id: 1 },
      ...
      { user_id: 4,  date: '2025-02-17', amount: 89.00, description: 'Alquiler', recurring: true, category_id: 2 },
      { user_id: 4,  date: '2025-02-22', amount: 99.00, description: 'Compra en supermercado', recurring: false, category_id: 1 },
      ...
      { user_id: 5,  date: '2025-01-19', amount: 86.00, description: 'Alquiler', recurring: true, category_id: 2 },
      { user_id: 5,  date: '2025-01-24', amount: 96.00, description: 'Compra en supermercado', recurring: false, category_id: 1 },
      ...
      { user_id: 5,  date: '2025-02-19', amount: 91.00, description: 'Alquiler', recurring: true, category_id: 2 },
      { user_id: 5,  date: '2025-02-24', amount: 101.00, description: 'Compra en supermercado', recurring: false, category_id: 1 },
    ], {});
  },
